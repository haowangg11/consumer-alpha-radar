...
def route_after_risk_critic(state: GraphState) -> str:
    ...
    proceed to investment synthesis. `retry_count` (incremented by
    the risk_critic node every pass) guarantees termination even if
    the critic keeps flagging issues.
    """
